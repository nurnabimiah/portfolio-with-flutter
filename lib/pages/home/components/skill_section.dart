    ...
    return Center(
      child: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          // Calculate the width based on the available constraints
          double scaledWidth = ScreenHelper.isMobile(context)
              ? constraints.maxWidth * 0.9 // 90% of the width for mobile
              : constraints.maxWidth * 0.7; // 70% for larger screens

          return ResponsiveScaledBox(
            width: scaledWidth, // Use the calculated width
            child: Flex(
