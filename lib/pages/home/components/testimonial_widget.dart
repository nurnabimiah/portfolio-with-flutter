...
import 'package:flutter_web_portfolio/models/testimonial.dart';
    ...
    child: LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        return ResponsiveScaledBox(
          width: width, // Set the width here for responsiveness
          child: Column(
              ...
              Container(
                ...
                child: RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text: "This is the portfolio section. There is a lot of work here",
